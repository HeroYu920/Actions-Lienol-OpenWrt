...
# 拉取ipsec-vpnd LuCI
svn co https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-ipsec-vpnd feeds/luci/applications/luci-app-ipsec-vpnd

# 拉取cpufreq LuCI
svn co https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-cpufreq feeds/luci/applications/luci-app-cpufreq
