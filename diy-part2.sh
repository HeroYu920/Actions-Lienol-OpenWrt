...
# 拉取ipsec-vpnd LuCI
svn co https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-ipsec-vpnd feeds/Lean/luci-app-ipsec-vpnd

# 拉取cpufreq LuCI
svn co https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-cpufreq feeds/Lean/luci-app-cpufreq
